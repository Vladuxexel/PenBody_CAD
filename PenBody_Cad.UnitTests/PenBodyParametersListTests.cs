...
namespace PenBody_Cad.UnitTests
{
    ...
    public class PenBodyParametersListTests
    {
        ...
        [TestCase(ParamName.MainLength, 60,
            TestName = "Позитивный тест установки длины основной части")]
        [TestCase(ParamName.RubberLength, 15,
            TestName = "Позитивный тест установки длины части для резинки")]
        [TestCase(ParamName.MainDiameter, 18,
            TestName = "Позитивный тест установки диаметра ручки")]
        [TestCase(ParamName.RubberDiameter, 13,
            TestName = "Позитивный тест установки диаметра части для резинки")]
        [TestCase(ParamName.InnerDiameter, 7,
            TestName = "Позитивный тест установки внутреннего диаметра")]
        public void Indexer_Set_GoodValue(ParamName name, double goodValue)
        {
            //Setup
            var penBodyParameter = new PenBodyParametersList();
